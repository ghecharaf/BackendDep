...
const multiDataSet = [
    {
        columns: [
            { title: "Debut", width: { wpx: 80 } },//pixels width 
            { title: "Message", width: { wch: 40 } },//char width 
            { title: "Durée", width: { wpx: 90 } },
            { title: "Ecran", width: { wpx: 90 } },
            { title: "21-20-2020", width: { wpx: 90 } },
            { title: "21-20-2020", width: { wpx: 90 } },
        ],
        data: [
            [
